...
class AllThrills extends StatefulWidget {
  // const AllThrills({ Key? key }) : super(key: key);

  @override
  _AllThrillsState createState() => _AllThrillsState();
}

class _AllThrillsState extends State<AllThrills> {
  final _abc = 20;
  @override
